...
<title>Nueva Unidad — Admin</title>
...
<header class="admin-topbar">
  <div class="topbar-left">
    ...
    <div class="topbar-breadcrumb"><a href="${pageContext.request.contextPath}/admin/unidades?accion=listar">Unidades</a><span class="sep">/</span><span>Nueva</span></div>
  </div>
...
<main class="admin-content">
  <div class="page-header"><div><span class="page-tag">// GESTIÓN</span><h1 class="page-title">NUEVA UNIDAD</h1></div></div>
  ...
  <div class="admin-panel" style="max-width:640px">
    <div class="admin-panel-header"><div class="admin-panel-title"><i class="bi bi-journal-plus"></i>DATOS DE LA UNIDAD</div></div>
        ...
        <div class="hp-form-grid">
          <div class="hp-field">
            ...
            <select name="numero" class="hp-select" required>
              ...
              <c:forEach begin="1" end="4" var="n"><option value="${n}">Unidad ${n}</option></c:forEach>
            </select>
          </div>
          <div class="hp-field hp-form-col-full">
            <label class="hp-label">Título <span class="required">*</span></label>
            <input type="text" name="titulo" class="hp-input" required maxlength="300" placeholder="Ej: Fundamentos de la Arquitectura de Software...">
          </div>
          <div class="hp-field hp-form-col-full">
            <label class="hp-label">Descripción</label>
            <textarea name="descripcion" class="hp-textarea" rows="4" placeholder="Descripción general de la unidad..."></textarea>
          </div>
        </div>
