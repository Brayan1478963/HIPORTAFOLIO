...
/**
 * DescargarArchivoServlet - Fuerza la descarga del archivo.
 * GET /archivos/descargar?id=X
 * @author HiPortafolio
 */
public class DescargarArchivoServlet extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(DescargarArchivoServlet.class.getName());
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            LOGGER.log(Level.WARNING, "Archivo no encontrado al descargar: id=" + id);
