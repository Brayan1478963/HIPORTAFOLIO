...
<title>Editar Tecnología — Admin</title>
...
<header class="admin-topbar">
  <div class="topbar-left"><button id="sidebar-mobile-btn" class="topbar-btn"><i class="bi bi-list fs-5"></i></button>
    <div class="topbar-breadcrumb"><a href="${pageContext.request.contextPath}/admin/tecnologias?accion=listar">Tecnologías</a><span class="sep">/</span><span>Editar</span></div></div>
  ...
  <div class="admin-panel" style="max-width:600px">
    ...
    <div class="admin-panel-body">
      <form action="${pageContext.request.contextPath}/admin/tecnologias" method="post">
        ...
        <input type="hidden" name="id" value="${entidad.idTecnologia}">
        <div class="hp-form-grid cols-2">
          ...
          <div class="hp-field">
            ...
            <select name="nivel" class="hp-select">
              <option value="Básico"     ${entidad.nivel eq 'Básico'     ? 'selected':''}>Básico</option>
              <option value="Intermedio" ${entidad.nivel eq 'Intermedio' ? 'selected':''}>Intermedio</option>
              <option value="Avanzado"   ${entidad.nivel eq 'Avanzado'   ? 'selected':''}>Avanzado</option>
            </select>
          </div>
          <div class="hp-field">
            <label class="hp-label">Categoría (ID)</label>
            <input type="number" name="idCategoria" class="hp-input" value="${entidad.idCategoria}">
          </div>
          <div class="hp-field">
          ...
          <div class="hp-field hp-form-col-full">
            <label class="hp-label">Ícono CSS</label>
            <input type="text" name="icono" class="hp-input" value="${entidad.icono}">
          </div>
